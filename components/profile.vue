<template>
	<div class="ts-container" :class="{'mobile-only': mobileOnly}">
		<div class="ts-box is-raised has-top-spaced-large" v-if="!profileImage">
		...
		<div class="ts-box is-raised has-top-spaced-large mobile-only" v-else>
			<div class="ts-content is-secondary">
				<div class="ts-grid is-middle-aligned profile-form">
